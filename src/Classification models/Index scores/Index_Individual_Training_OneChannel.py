...
results_data_file_name = 'PICU_TrainScores_%s_%s_Individuals_%s.xlsx' % (feature_name_file, eeg_channel.replace(':', ''), number_of_stages_key)
...
for feature_data_file_name in feature_data_file_names:
    if feature_data_file_name.endswith('.xlsx'):
        print(datetime.now(), ': Loading of %s started' % feature_data_file_name)
        ...
        """
        print(datetime.now(), ': Threshold calculation of %s started' % feature_data_file_name)
        ...
        """
        print(datetime.now(), ': Threshold testing of %s started' % feature_data_file_name)
        ...
        print(datetime.now(), ': %s completed' % feature_data_file_name)
...
print('FINISHED: Individual index thresholds determination completed')
